...
out_fn = "ros_data/imu_to_kfgins_"+ date_time +".txt"
...
if __name__ == "__main__":
    ...
    out_data = np.zeros((len(imu_file), 8))
    print(len(imu_file))
    ...
    out_data[:, 0] = (imu_file[:, 0] - 315964800) % 604800
    out_data[:, 1] = rolls * 0
    out_data[:, 2] = pitches * 0
    out_data[:, 3] = -yaws
